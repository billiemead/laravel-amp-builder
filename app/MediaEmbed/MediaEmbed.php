...
namespace App\MediaEmbed;

use App\MediaEmbed\Object\MediaObject;
...
class MediaEmbed
{
    ...
    {
        include dirname(__FILE__).DIRECTORY_SEPARATOR .'Data'.DIRECTORY_SEPARATOR.'stubs.php';
        $this->setHosts($stubs);
     ...
     * @return array
     */
    protected function _matchUrl($url, $regexRules)
    {
