...
class AsignRolePermission extends GeneratorCommand
{
    /**
    ...
    protected $signature = 'role:permission {name} {permission_name}';
    /**
     * The console command description.
     *
     * @var string
     */
    protected $description = 'Asign Permission to a Role';
    ...
    public function handle()
    {
        ...
        $permissions = $permissionClass::where([
            'name' => $this->argument('permission_name'),
        ])->get();
        $roleClass = app(RoleContract::class);

        $roles = $roleClass::where([
        ...
        foreach ($roles as $role) {
            ...
            foreach ($permissions as $permission) {
                ...
                if ($role->guard_name == $permission->guard_name) {
                    ...
                    $this->info($role->name. ' given permission '. $permission->name. "\n");
                }
            }
        }
    }
