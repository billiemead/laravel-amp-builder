...
class CreateVisitortrackerVisitorsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('visitortracker_visitors', function (Blueprint $table) {
    ...
    {
        Schema::drop('visitortracker_visitors');
    }
}
