export default function($scope, communication,$window,popup_module_options, pageEdit_event, $state,commonUtils)
{
	"ngInject";
	communication.getList('moduleOptions').then( function(json)
	{
		$scope.options = json;
	});
	$scope.menuOptions = 
	...
	function saveOptions(options){
		return communication.api('saveModuleOptions', {options:options});
	}
