...
var Selection = {
	...
	getSelectionNode: function(contentWindow)
	{
		!contentWindow && (contentWindow = window);
		return this.findMatchingSelectionParent(function (el) {
			return pageEdit.getModule(el) != undefined;
		}, contentWindow);
	},
	getParentElement: function(textNode, tag)
	{
		if(!textNode || textNode.nodeType != 3)
			return;
		return Util.traverseUp(textNode, function(el)
		{
			return pageEdit.getModule(el) != undefined && (tag == undefined || el.tagName.toLowerCase() == tag.toLowerCase());
		});
	...
	getIndexRelativeToAdjacentEmptyBlocks: function (doc, root, cursorContainer, cursorOffset) {
		...
		if (node) {
			...
			var previousSibling = Util.findPreviousSibling(node);
	...
	getSelection: function (ownerDocument) {
	...
	createRangeFromNode: function(node) {
	...
	getRangeTextNodes: function(range) {
	...
	getRangesFromTextNodes: function(range, textNodes)
	{
		var ranges = [];
		var startNode = range.startContainer, 
