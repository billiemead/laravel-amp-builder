...
(function(window, factory) {
  if (typeof defined === 'function' && defined.amd) {
    return defined(['jquery'], function(jQuery) {
  ...
  Tour = (function() {
    function Tour(options) {
      ...
      this._options = $.extend({
        ...
        delay: false,
        basePath: '',
        template: '<div class="popover" role="tooltip"> <div class="arrow"></div> <h3 class="popover-title"></h3> <div class="popover-content"></div> <div class="popover-navigation"> <div class="btn-group"> <button class="btn btn-sm btn-default" data-role="prev">&laquo; Prev</button> <button class="btn btn-sm btn-default" data-role="next">Next &raquo;</button> <button class="btn btn-sm btn-default" data-role="pause-resume" data-pause-text="Pause" data-resume-text="Resume">Pause</button> </div> <button class="btn btn-sm btn-default" data-role="end">End tour</button> <div><label><input type="checkbox" name="dontshownext" data-role="dontshow">Don\'t show again</label></div></div> </div>',
    ...
    Tour.prototype._template = function(step, i) {
	  ...
	  $dontshow = $navigation.find('[data-role="dontshow"]');
	  if(this._getState('dontshownext'))
		  $dontshow.attr('checked', 'checked');
    ...
    Tour.prototype._initMouseNavigation = function() {
      ...
      }).on("click.tour-" + this._options.name, ".popover.tour-" + this._options.name + " *[data-role='dontshow']", (function(_this) {
        return function(e) {
			_this._setState('dontshownext', $(this).is(':checked'));
          //e.preventDefault();
         // return _this.next();
        };
      })(this));
