...
import logger from '../../../node_modules/quill/core/logger';
import Module from '../../../node_modules/quill/core/module';
...
class Toolbar extends Module {
  constructor(quill, options) {
    ...
    if (Array.isArray(this.options.container)) {
      ...
      this.container = doc.querySelector(this.options.container);
    } else {
      this.container = this.options.container;
    }
	
    if (!((this.container instanceof window.parent.HTMLElement) || (this.container instanceof HTMLElement)) ) {
		console.log('this.container', this.container, window.parent);
    ...
    [].forEach.call(this.container.querySelectorAll('button, select, input'), (input) => {
      this.attach(input);
    });
  ...
  attach(input) {
    ...
    input.addEventListener(eventName, (e) => {
	  ...
	  console.log('this.handlers[format] ', this.handlers[format] );
      if (this.handlers[format] != null) {
...
function addControls(container, groups) {
  ...
  groups.forEach(function(controls) {
	  var doc = window.parent.document;
    let group = doc.createElement('span');
